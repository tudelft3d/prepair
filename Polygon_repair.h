...
public:
  ...
  void repair_odd_even(Geometry &in_geometry, Multi_polygon<Point> &out_geometry, bool time_results = false);
  void repair_point_set(Linear_ring<Point> &in_geometry, Multi_polygon<Point> &out_geometry, bool time_results = false);
  void repair_point_set(Polygon<Point> &in_geometry, Multi_polygon<Point> &out_geometry, bool time_results = false);
  void repair_point_set(Multi_polygon<Point> &in_geometry, Multi_polygon<Point> &out_geometry, bool time_results = false);
private:
  Triangulation triangulation;
  
  void insert_constraints(Triangulation &triangulation, Linear_ring<Point> &in_geometry, bool remove_overlapping_constraints = true);
  void insert_constraints(Triangulation &triangulation, Polygon<Point> &in_geometry, bool remove_overlapping_constraints = true);
...
template <class Geometry>
void Polygon_repair::repair_odd_even(Geometry &in_geometry, Multi_polygon<Point> &out_geometry, bool time_results) {
  triangulation.clear();
